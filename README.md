...
## Background
25+ years in engineering and program delivery — Siemens (services and DoD program management), Hexagon/Intergraph (global 3D certification lead), Northrop Grumman Newport News Shipbuilding, Boeing. Domains: mechanical, marine, and structural engineering; CAD/3D; PLM (Teamcenter/NX, SmartMarine3D); defense acquisition; contracts.

## Now
Open to contract, contributor-level AI evaluation and data-annotation work.
